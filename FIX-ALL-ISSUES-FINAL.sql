-- =====================================================
-- FINAL FIX: All Issues - RLS + Missing Columns
-- Run this ENTIRE script in Supabase SQL Editor
-- =====================================================

-- =====================================================
-- PART 1: Add Missing Product Columns
-- =====================================================
...
WHERE table_name = 'product' 
  AND column_name IN ('express_shipping', 'free_shipping', 'shipping_cost', 'subcategory')
ORDER BY column_name;

-- =====================================================
-- PART 2: Fix Profile Table RLS (CRITICAL for Signup!)
-- =====================================================
...
-- =====================================================
-- PART 3: Fix Product Table RLS (Products Not Showing)
-- =====================================================
...
-- =====================================================
-- PART 4: Fix Storage Bucket RLS (Image Uploads)
-- =====================================================
...
-- =====================================================
-- PART 5: Protect User Type (Prevent Seller -> Buyer)
-- =====================================================
...
FROM information_schema.columns 
WHERE table_name = 'product' 
  AND column_name IN ('express_shipping', 'free_shipping', 'shipping_cost', 'subcategory', 'seller_id')
ORDER BY column_name;
