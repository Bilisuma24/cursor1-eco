...
export default function About() {
  return (
    <div className="page-container text-center overflow-x-hidden">
      ...
      <h1 className="text-2xl sm:text-3xl lg:text-4xl mb-3 sm:mb-4 px-3 sm:px-0">About Kush deals</h1>
      <p className="text-gray-600 max-w-2xl mx-auto text-sm sm:text-base lg:text-lg px-3 sm:px-4 leading-relaxed">
        At Kush deals, our mission is simple — to promote sustainable living by
